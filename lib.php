...
$scss .= "body#page-login-signup .card-body,body.pagelayout-login #page #page-content #region-main .login-main-wrapper,body.pagelayout-login #page #page-content #region-main .login-main-wrapper button:hover {background-image: url([[pix:theme|tr]]);}";
